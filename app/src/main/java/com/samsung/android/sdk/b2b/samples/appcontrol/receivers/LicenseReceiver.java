 ...
 * and source code.
 */
package com.samsung.android.sdk.b2b.samples.appcontrol.receivers;
        ...
        if (intent != null) {
            ...
            //If ELM activation result Intent is obtained
                ...
                if (handler != null && errorCode == EnterpriseLicenseManager.ERROR_NONE) {
                    ...
                    SAUtils.displayToast(context, context.getResources().getString(R.string.elm_activated_succesfully));
                ...
                //If ELM activation failed
                    ...
                    String errorMessage = SAUtils.getMessage(context,errorCode);
